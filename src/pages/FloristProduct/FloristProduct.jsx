...
const FloristProduct = () => {
  ...
  const currentData =
    activeTab === "Buket" ? productState.data : itemState.data;
  ...
  return (
    <div className="FloristDashboardContainer">
      <h1 className="FloristDashboardTitle">Inventaris Stok</h1>
      ...
      <div className="FloristOrdersTableSection">
        ...
        {(activeTab === "Buket" && productState.loading) ||
        (activeTab === "Item" && itemState.loading) ? (
          <SectionLoading />
        ) : (activeTab === "Buket" && productState.error) ||
          (activeTab === "Item" && itemState.error) ? (
          <SectionError
            onRetry={activeTab === "Buket" ? fetchProducts : fetchItems}
          />
        ) : (
          <>
                ...
                <thead>
                  <tr>
                    ...
                    <th className="p2 weight-semibold">
                      {activeTab === "Buket" ? "Komponen" : "Produk Dasar"}
                    </th>
                  ...
                  {displayedItems.length > 0 ? (
                    displayedItems.map((item) => (
                      <tr key={item._id}>
                        ...
                        <td className="p2">
                          {activeTab === "Buket"
                            ? item.ProductDetail?.map(
                                (d) =>
                                  `${d.ItemId?.Name || "Item"} (x${d.Quantity})`,
                              ).join(", ")
                        ...
                        <td>
                          ...
                          >
                            <FaRegTrashAlt
                              ...
                              onClick={() =>
                                handleSingleDelete(item._id, item.Name)
                              }
                            />
                            <FaRegEdit
                              className="InventoryActionIcon"
            ...
            <div className="InventoryFooterContainer">
              ...
              <div className="InventoryActionButtons">
                ...
                <button className="InventoryBtnAdd" onClick={handleNavigateAdd}>
                  Tambah
                </button>
              </div>
            </div>
